          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: AppColors.sbBlue.withOpacity(0.1)),
              ),
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                        color: AppColors.sbBlue, shape: BoxShape.circle),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Pastikan bluetooth printer aktif',
                            style: TextStyle(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.print, color: Colors.grey.shade400),
                      const SizedBox(width: 12),
                      const Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildSwitchTile('Auto Print Struk', autoPrint,
                      (v) => setState(() => autoPrint = v)),
                  const Divider(height: 1),
                  _buildSwitchTile('Cetak Logo Toko', printLogo,
                      (v) => setState(() => printLogo = v)),
                  const Divider(height: 1),
                  ListTile(
