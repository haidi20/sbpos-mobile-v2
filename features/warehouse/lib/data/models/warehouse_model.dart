...
class WarehouseModel {
  ...
  static bool? _toBool(dynamic value) {
    ...
    return false; // atau null, tergantung kebutuhan
  }
  ...
  WarehouseEntity toEntity() => WarehouseEntity(
        ...
        // distance: distance,
        isActive: isActive ?? false, // Assuming default value for isActive
        deletedAt: deletedAt,
        createdAt: createdAt,
        updatedAt: updatedAt,
        syncedAt: syncedAt,
  ...
  factory WarehouseModel.fromDbLocal(Map<String, dynamic> map) {
    int? toInt(dynamic v) {
